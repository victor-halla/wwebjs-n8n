...
import type { CODE_EXECUTION_MODES, CODE_LANGUAGES, LOG_LEVELS, BINARY_MODE_COMBINED, BINARY_MODE_SEPARATE } from './constants';
...
export declare const ChatNodeMessageType: {
...
export type NodeParameterValueType = NodeParameterValue | INodeParameters | INodeParameterResourceLocator | ResourceMapperValue | FilterValue | AssignmentCollectionValue | IconOrEmoji | NodeParameterValue[] | INodeParameters[] | INodeParameterResourceLocator[] | ResourceMapperValue[];
export interface INodeParameters {
    [key: string]: NodeParameterValueType;
}
export type NodePropertyTypes = 'boolean' | 'button' | 'collection' | 'color' | 'dateTime' | 'fixedCollection' | 'hidden' | 'icon' | 'json' | 'callout' | 'notice' | 'multiOptions' | 'number' | 'options' | 'string' | 'credentialsSelect' | 'resourceLocator' | 'curlImport' | 'resourceMapper' | 'filter' | 'assignmentCollection' | 'credentials' | 'workflowSelector';
...
export type AgentRequestQuery = {
    [nodeName: string]: Record<string, unknown> | string;
};
