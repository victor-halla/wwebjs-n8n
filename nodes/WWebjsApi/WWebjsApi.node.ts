    ...
    for (let i = 0; i < items.length; i++) {
      ...
      case "ChannelChat": {
        ...
        case "postChannelGetClassInfo": {
          const sessionIdParam = this.getNodeParameter("sessionId", i) as { mode: string; value: string };
        ...
        case "postChannelFetchMessages": {
          ...
          const options: IHttpRequestOptions = {
            ...
            body: {
            chatId: this.getNodeParameter("body_chatId", i) as string,
            searchOptions: (() => { try { return JSON.parse(this.getNodeParameter("body_searchOptions", i) as string); } catch { return {}; } })(),
            },
        ...
        case "postChannelSetProfilePicture": {
          ...
          const options: IHttpRequestOptions = {
            ...
            newProfilePictureMedia: (() => { try { return JSON.parse(this.getNodeParameter("body_newProfilePictureMedia", i) as string); } catch { return {}; } })(),
            },
      ...
      case "Chat": {
        ...
        case "postChatChangeLabels": {
          ...
          const options: IHttpRequestOptions = {
            ...
            body: {
            chatId: this.getNodeParameter("body_chatId", i) as string,
            labelIds: (() => { try { return JSON.parse(this.getNodeParameter("body_labelIds", i) as string); } catch { return {}; } })(),
            },
      ...
      case "Client": {
        ...
        case "postClientCreateGroup": {
          ...
          const options: IHttpRequestOptions = {
            ...
            participants: (() => { try { return JSON.parse(this.getNodeParameter("body_participants", i) as string); } catch { return {}; } })(),
            options: (() => { try { return JSON.parse(this.getNodeParameter("body_options", i) as string); } catch { return {}; } })(),
            },
        ...
        case "postClientAddOrRemoveLabels": {
          ...
          const options: IHttpRequestOptions = {
            ...
            body: {
            labelIds: (() => { try { return JSON.parse(this.getNodeParameter("body_labelIds", i) as string); } catch { return {}; } })(),
            chatIds: (() => { try { return JSON.parse(this.getNodeParameter("body_chatIds", i) as string); } catch { return {}; } })(),
            },
        ...
        case "postClientGetContactLidAndPhone": {
          ...
          const options: IHttpRequestOptions = {
            ...
            headers: { "x-api-key": apiKey, "Content-Type": "application/json" },
            body: {
            userIds: (() => { try { return JSON.parse(this.getNodeParameter("body_userIds", i) as string); } catch { return {}; } })(),
            },
      ...
      case "GroupChat": {
        ...
        case "postGroupChatAddParticipants": {
          ...
          const options: IHttpRequestOptions = {
            ...
            body: {
            chatId: this.getNodeParameter("body_chatId", i) as string,
            participantIds: (() => { try { return JSON.parse(this.getNodeParameter("body_participantIds", i) as string); } catch { return {}; } })(),
            options: (() => { try { return JSON.parse(this.getNodeParameter("body_options", i) as string); } catch { return {}; } })(),
            },
