                            ...
                            case "postChannelSetProfilePicture": {
                                ...
                                const options = {
                                    ...
                                    body: {
                                        ...
                                        newProfilePictureMedia: this.getNodeParameter("body_newProfilePictureMedia", i),
                                    },
                                    returnFullResponse: false,
                                    json: true,
                                };
                        ...
                        switch (operation) {
                            ...
                            case "postChatChangeLabels": {
                                ...
                                const options = {
                                    ...
                                    body: {
                                        chatId: this.getNodeParameter("body_chatId", i),
                                        labelIds: this.getNodeParameter("body_labelIds", i),
                                    },
                                    returnFullResponse: false,
                                    json: true,
                                };
                        ...
                        switch (operation) {
                            ...
                            case "postClientAddOrRemoveLabels": {
                                ...
                                const options = {
                                    ...
                                    body: {
                                        labelIds: this.getNodeParameter("body_labelIds", i),
                                        chatIds: this.getNodeParameter("body_chatIds", i),
                                    },
                                    returnFullResponse: false,
                                    json: true,
                                };
                            ...
                            case "postClientGetContactLidAndPhone": {
                                ...
                                const options = {
                                    ...
                                    headers: { "x-api-key": apiKey, "Content-Type": "application/json" },
                                    body: {
                                        userIds: this.getNodeParameter("body_userIds", i),
                                    },
                                    returnFullResponse: false,
                                    json: true,
                                };
                        ...
                        switch (operation) {
                            ...
                            case "postGroupChatAddParticipants": {
                                ...
                                const options = {
                                    ...
                                    body: {
                                        chatId: this.getNodeParameter("body_chatId", i),
                                        participantIds: this.getNodeParameter("body_participantIds", i),
                                        options: this.getNodeParameter("body_options", i),
                                    },
                                    returnFullResponse: false,
                                    json: true,
